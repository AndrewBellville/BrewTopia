 ...
 */
public class UpdateUserSettingsRequest extends StringRequest {
    private static String URL = APPUTILS.WEBAPIRURL+"/UpdateUserSettings";
    private Map<String, String> params;

    public UpdateUserSettingsRequest(UserSchema aUserSchema, Response.Listener<String> listener, Response.ErrorListener errorListener) {
